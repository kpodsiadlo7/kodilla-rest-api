...
class TrelloControllerTest {
    ...
    void shouldFetchTrelloBoards() throws Exception {
        // given
        List<TrelloListDto> trelloListDto = List.of(new TrelloListDto("1", "list name", false));
        List<TrelloBoardDto> trelloBoards = List.of(new TrelloBoardDto("1", "board", trelloListDto));
        ...
        mockMvc
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].lists[0].name", Matchers.is("list name")))
